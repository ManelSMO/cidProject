...
VALUES 
  (1, '12345678900', 'senha_cidadao_1'),  
  (3, '98765432100', 'senha_cidadao_2'),
  (4, '98765432101', 'senha_cidadao_3'),  
  (5, '98765432102', 'senha_cidadao_4'),  
  (6, '98765432103', 'senha_cidadao_5'),  
  (7, '98765432104', 'senha_cidadao_6'),  
  (8, '98765432105', 'senha_cidadao_7'),  
  (9, '98765432106', 'senha_cidadao_8'),  
  (10, '98765432107', 'senha_cidadao_9');  
	   
-- Inserção de acesso para policiais
INSERT INTO acesso_policial (usuarioidusu, matfun, senhafun) 
VALUES 
  (2, 'POL1234', 'senha_policial_1');  -- Acesso do policial 1

	
-- Pessoa
-- Inserindo pessoas (cidadaos)
INSERT INTO public.pessoa 
(nompes, estcivpes, datnaspes, numtelpes, emailpes, genpes, acesso_cidadao, Fotpes)
VALUES 
...
-- inserindo pessoas(policiais)
INSERT INTO public.pessoa 
(nompes, estcivpes, datnaspes, numtelpes, emailpes, genpes, acesso_policial, Fotpes)
VALUES 
...
VALUES
('Carlos Silva', 'Vítima de roubo no centro da cidade', '12345678901', 11987654321, '1985-04-15', 'carlos.silva@email.com', 1, 'VÍTIMA'),
('Ana Pereira', 'Testemunha do acidente de trânsito', '98765432100', 11976543210, '1992-07-30', 'ana.pereira@email.com', 2, 'TESTEMUNHA');
